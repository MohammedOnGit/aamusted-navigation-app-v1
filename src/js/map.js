...
const autonomyAnexPopupTxt = 'Autonomy hall anex <button type="button" class="btn btn-link" data-bs-toggle="modal"  data-bs-target="#autonomy-anex">View</button>';

//UBS
const UBSAnexPopupTxt = 'University Basic Scholl<button type="button" class="btn btn-link" data-bs-toggle="modal"  data-bs-target="#usb">View</button>';

//Ict and library block
const ictLibraryBlockAnexPopupTxt = 'ICT & Library Block<button type="button" class="btn btn-link" data-bs-toggle="modal"  data-bs-target="#ict-library">View</button>';

//aamuste clinic
const aamustedClinicPopupTxt = 'AAMUSTED Clinic<button type="button" class="btn btn-link" data-bs-toggle="modal"  data-bs-target="#aamusted-clinic">View</button>';

//New Lecture block
const newLectureBlockPopupTxt = 'New lecture block (NLB)<button type="button" class="btn btn-link" data-bs-toggle="modal"  data-bs-target="#new-lecture-block">View</button>';

//Opoku ware tenis court
const opokuWareTenisCourtPopupTxt = 'Opoku Ware tenis court<button type="button" class="btn btn-link" data-bs-toggle="modal"  data-bs-target="#opoku-ware-tenis">View</button>';

//aamusted canteen
const aamustedCanteenPopupTxt = 'AAMUSTED canteen<button type="button" class="btn btn-link" data-bs-toggle="modal"  data-bs-target="#aamuste-canteen">View</button>';

//new foculty
const newFocultyBuildingPopupTxt = 'New foculty building<button type="button" class="btn btn-link" data-bs-toggle="modal"  data-bs-target="#new-foculty-building">View</button>';

//campus security post
const campusSecurityPostPopupTxt = 'Campus security post<button type="button" class="btn btn-link" data-bs-toggle="modal"  data-bs-target="#campus-security">View</button>';

//TL block
const TLblockPostPopupTxt = 'TL block<button type="button" class="btn btn-link" data-bs-toggle="modal"  data-bs-target="#tl-block">View</button>';

//Old library
const oldLibraryPopupTxt = 'Old library<button type="button" class="btn btn-link" data-bs-toggle="modal"  data-bs-target="#old-library">View</button>';

//AAMUSTED workshop
const aamustedWorkShopPopupTxt = 'AAMUSED Workshop<button type="button" class="btn btn-link" data-bs-toggle="modal"  data-bs-target="#aamusted-workshop">View</button>';

const aamustedFootballPitchPopupTxt='AAMUSED football pitch<button type="button" class="btn btn-link" data-bs-toggle="modal"  data-bs-target="#aamusted-football-pitch">View</button>';

const kwamanmnaRuralBankPopupTxt = 'Kwamanman rural bank<button type="button" class="btn btn-link" data-bs-toggle="modal"  data-bs-target="#kwamanman-rural-bank">View</button>';

const srcSecretarietPopupTxt = 'SRC secretariet<button type="button" class="btn btn-link" data-bs-toggle="modal"  data-bs-target="#src-secretariet">View</button>';

const aamustedMainEntrancePopupTxt = 'AAMUSTED main entrance<button type="button" class="btn btn-link" data-bs-toggle="modal"  data-bs-target="#main-entrance">View</button>';


const automotiveWorkshopPopupTxt = 'Automotive workshop<button type="button" class="btn btn-link" data-bs-toggle="modal"  data-bs-target="#automotive-workshop">View</button>';

const frankyJayPopupTxt = 'Franky jay<button type="button" class="btn btn-link" data-bs-toggle="modal"  data-bs-target="#franky-jay">View</button>';

const ubaPopupTxt = 'UBA<button type="button" class="btn btn-link" data-bs-toggle="modal" data-bs-target="#uba">View</button>';

const constructionLabPopupTxt = 'Construction lab/workshop<button type="button" class="btn btn-link" data-bs-toggle="modal" data-bs-target="#construction-lab">View</button>';
...
const coordinatesData = [
  ...
  {
    coordinates: [6.69753,-1.68172],
    title: "Old library",
    buttonId: "old-library",
    popupText: oldLibraryPopupTxt,
  },
  {
    coordinates: [6.69687,-1.68141],
    title: "TL block",
    buttonId: "TL block",
    popupText: TLblockPostPopupTxt,
  },
  {
    coordinates: [6.69676,-1.68220],
...
coordinatesData.forEach(function (data) {
  ...
  searchMarkers.push(marker); // Make sure each marker is added to searchMarkers
});
